...
class PHPExcel_Reader_CSV extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
	...
	public function load($pFilename)
	{
		...
		return $this->loadIntoExisting($pFilename, $objPHPExcelLoad);
	}
	 ...
	 * @throws 	PHPExcel_Reader_Exception
	 */
	public function loadIntoExisting($pFilename, PHPExcel $objPHPExcelLoad)
	{
		...
		while ($objPHPExcelLoad->getSheetCount() <= $this->_sheetIndex) {
			$objPHPExcelLoad->createSheet();
		}
		$sheet = $objPHPExcelLoad->setActiveSheetIndex($this->_sheetIndex);
